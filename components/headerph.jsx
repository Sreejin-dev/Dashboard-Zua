...
const Headerph = () => {
  ...
  return (
    <div className="md:hidden w-full absolute z-50">
...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={` text-white w-10 h-10 ${hidden ? 'block' : 'hidden'}`} onClick={toggleHidden}>
