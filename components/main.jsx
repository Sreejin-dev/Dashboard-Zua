  ...
  return (
    <div className="text-white flex justify-center items-center h-screen">
      <div className="gap-5 flex flex-col">
        ...
        <div className="font-bold gap-5 flex text-5xl">
          <button className="text-[#24C8B0] border border-[#2A4A3D] border-4 p-2 px-10 rounded-3xl hover:border-[#0AF2A9] hover:text-[45px] transition-all">
            Invite Me
          </button>
